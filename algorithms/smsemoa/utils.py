...
class SMSEMOAUtils:
    ...
    def reduce(self, population, ref):
        ...
        #[print(x.objectives) for x in population.population]
        for x in population.population:
            for o in x.objectives:
                if o is float('nan'):
                    print('')
                    print(x.objectives)        
